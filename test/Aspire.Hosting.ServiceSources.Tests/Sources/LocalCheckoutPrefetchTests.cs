...
public class LocalCheckoutPrefetchTests
{
    ...
    /// outside <c>.servicesources/checkouts/</c> — outside the <c>.gitignore</c> and the build
    /// barrier that are there to keep a checkout out of the AppHost's git status and build
    /// settings (#224).
    /// </summary>
    [Fact]
